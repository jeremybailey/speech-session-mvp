...
struct HomeView: View {
    ...
    private enum RecordingPhase { case idle, recording, transcribing }
    ...
    private var recordingControl: some View {
        ...
        .padding(.vertical, 16)
        // Block touches from falling through the floating area to list rows beneath.
